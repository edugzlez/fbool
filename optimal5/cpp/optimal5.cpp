...
#ifdef _MSC_VER
    __m128i perm_vec = _mm_loadu_si128((__m128i *)perm);
    __m128i y_vec1 = _mm_loadu_si128((__m128i *)y);
    __m128i y_vec2 = _mm_loadu_si128((__m128i *)(y + 16));
    __m128i perm2 = _mm_loadu_si128((__m128i *)(perm + 16));

    __m128i result1 = _mm_shuffle_epi8(perm_vec, y_vec1);
    __m128i result2 = _mm_shuffle_epi8(perm_vec, y_vec2);

    _mm_storeu_si128((__m128i *)y, result1);
    _mm_storeu_si128((__m128i *)(y + 16), result2);
